...
//
//     final url = Uri.parse(
//         'http://192.168.1.6:8000/api/business_users/');
//
//     try {
...
//               context,
//               MaterialPageRoute(builder: (context) => FirstScreen(companyName: widget.companyName),
//             ));
//           } else {
//             ScaffoldMessenger.of(context).showSnackBar(
...
class SignInController extends GetxController {
  ...
  void signIn() {
    if (validateInputs()) {
      ...
      Get.offAll(() => FirstScreen(companyName: Get.find<SignUpController>().companyName.value)); // Navigate to the dashboard or home page
    }
  }
}
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Get.to(() => SignUpPage()); // Navigate back to Sign Up page
                },
                child: Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: Text(
